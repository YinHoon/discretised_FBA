...
dest_figname = abspath(join(THIS_DIR, '..', 'results', 'deterministic_moderate_gradients_line.tiff'))
...
dest_figname = abspath(join(THIS_DIR, '..', 'results', 'deterministic_moderate_gradients_bar.tiff'))
fig.savefig(dest_figname, dpi=1200)
