...
dest_figname = abspath(join(THIS_DIR, '..', 'results', 'deterministic_steep_gradients_line.eps'))
...
dest_figname = abspath(join(THIS_DIR, '..', 'results', 'deterministic_steep_gradients_bar.eps'))
fig.savefig(dest_figname, dpi=1200)
